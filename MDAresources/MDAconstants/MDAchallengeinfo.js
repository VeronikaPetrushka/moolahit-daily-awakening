const challengeinfo = [
    ...
    {
        level: 2,
        title: 'Level 2 — Seeker of Stillness',
        tasks: [
    ...
    {
        level: 3,
        title: 'Level 3 — Breaker of Loops',
        tasks: [
            "Let go of one thing that weighs you down.",
    ...
    {
        level: 4,
        title: 'Level 4 — Guardian of Flow',
        tasks: [
            "Pause 2 seconds before each action.",
            "Do something small you’ve been avoiding.",
    ...
    {
        level: 5,
        title: 'Level 5 — Mind Archer',
        tasks: [
            "Forgive someone silently. Just once.",
            "Walk without headphones. Catch the rhythm of the street.",
    ...
    {
        level: 6,
        title: 'Level 6 — Flame of Presence',
        tasks: [
            "Move slower than usual — on purpose.",
            "Before any task, say: “I am here.”",
    ...
    {
        level: 7,
        title: 'Level 7 — The Clear One',
        tasks: [
            "Close your eyes. Listen to your breath for 1 minute.",
            "Draw something. A line. A word. A feeling.",
